...
export const BONUSES: BonusItem[] = [
  {
    id: 'bonus-1',
    badge: '🎁 BÔNUS 1 🎁',
    title: '✅ CRIE SUA PRIMEIRA VELA DE SUCESSO',
    originalPrice: 'R$67,00',
    description: 'Produza a sua primeira vela já com maestria com esse módulo! Veja como evitar os erros mais comuns e comece com total segurança.',
    image: '/bonus_img_1.png',
    fallbackImage: 'https://i.imgur.com/bv2YOOd.png',
  },
  {
    id: 'bonus-2',
    badge: '🎁 BÔNUS 2 🎁',
    ...
    image: '/bonus_img_2.png',
    fallbackImage: 'https://i.imgur.com/xPTibAC.png',
  },
  {
    id: 'bonus-3',
    badge: '🎁 BÔNUS 3 🎁',
    title: '✅ NOVOS MODELOS DE VELAS DECORATIVAS',
    originalPrice: 'R$37,00',
    description: 'Aprenda modelos novos do mercado e saia na frente da maioria com ideias e formatos modernos para encantar clientes.',
    image: '/bonus_img_3.png',
    fallbackImage: 'https://i.imgur.com/cnHlxnR.png',
  },
  {
    id: 'bonus-4',
    badge: '🎁 BÔNUS 4 🎁',
    ...
    image: '/bonus_img_4.png',
    fallbackImage: 'https://i.imgur.com/MtNRiv1.png',
  },
];
